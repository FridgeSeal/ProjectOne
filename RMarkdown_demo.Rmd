...
CTRHourly = ggplot(HourData, aes(x = Hour)) + # CTR by hour plot, to be deprecated
  geom_path(aes(y = CTR)) +
...
CTRCirclePlot = ggplot(HourData, aes(x=Hour)) + # Messy and less than ideal, to be deprecated in favour of heatmap plot
